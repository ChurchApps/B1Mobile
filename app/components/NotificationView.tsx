...
export function NotificationTab(props: any) {
    ...
    return (
      <TouchableOpacity onPress={() =>
        router.navigate({
          ...
          params: {
            userDetails: JSON.stringify(userchatDetails)
          },
        })
  ...
  const renderItems = (item: any, index: number) => {
    ...
    return (
      <TouchableOpacity style={globalStyles.NotificationView} onPress={() => {
        router.navigate({
          pathname: '/(drawer)/planDetails',
          params: {
            id: JSON.stringify(item?.contentId)
          },
        })
      }}>
