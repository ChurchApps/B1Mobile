...
export function CustomDrawer(props: any) {
  ...
  const messagesView = () => {
    return (
      <TouchableOpacity onPress={() => router.navigate('/searchMessageUser')}>
        <View style={globalStyles.messageRootView}>
          <MaterialCommunityIcons name={"email"} color={'black'} style={globalStyles.tabIcon} size={DimensionHelper.wp('5%')} />
        </View>
      </TouchableOpacity>
    );
  }
