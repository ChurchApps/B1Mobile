...
import { Provider as PaperProvider, Appbar, Text, useTheme, MD3LightTheme } from 'react-native-paper';
        ...
        <LoadingWrapper loading={areMethodsLoading}>
          <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: theme.colors.background }} contentContainerStyle={{ padding: spacing.md }}>
              ...
              {!UserHelper.currentUserChurch?.person?.id ? (
                <Text variant="bodyMedium" style={{ marginVertical: spacing.md, color: theme.colors.onSurface }}>Please login to view existing donations</Text>
              ) : (
                <>
