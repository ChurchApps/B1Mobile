...
export const useNavigation = () => {
  ...
  const navigateTo = useCallback((screen: string, params?: Record<string, any>, options?: NavigationOptions) => {
  ...
  const navigateBack = useCallback((fallbackRoute: string = "/(drawer)/dashboard") => {
  ...
  const navigateReplace = useCallback((screen: string, params?: Record<string, any>, options?: NavigationOptions) => {
    const { logEvent = true } = options || {};
  ...
  const navigateDismissAll = useCallback((screen: string, params?: Record<string, any>, options?: NavigationOptions) => {
    const { logEvent = true } = options || {};
   ...
   */
  const navigateWithStack = useCallback((screen: string, params?: Record<string, any>, options?: NavigationOptions) => {
    const { logEvent = true } = options || {};
