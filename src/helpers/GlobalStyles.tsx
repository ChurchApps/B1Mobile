...
export const globalStyles = StyleSheet.create({
  ...
  roundBlueButton: { height: DimensionHelper.wp(12), borderRadius: DimensionHelper.wp(2), justifyContent: 'center', alignItems: 'center', alignSelf: 'center', backgroundColor: Constants.Colors.button_bg, marginTop: DimensionHelper.wp(5) },
  ...
  groupText: {
    color: Constants.Colors.app_color, fontSize: DimensionHelper.wp(4.2), marginHorizontal: DimensionHelper.wp(2.5), shadowColor: Constants.Colors.app_color,
    shadowOffset: { width: 10, height: 10 },
    shadowOpacity: 1.0,
    shadowRadius: 3,
    elevation: 15,
  },
  FlatListStyle: { flexGrow: 1, paddingBottom: DimensionHelper.wp(10) },
  FlatlistViewStyle: {
    borderRadius: DimensionHelper.wp(0.8), paddingBottom: DimensionHelper.wp(3),
    ...
    marginVertical: DimensionHelper.wp(1), backgroundColor: Constants.Colors.white_color, alignSelf: 'center'
  },
  ...
  TitleStyle: {
    ...
    borderTopRightRadius: DimensionHelper.wp(0.8),
  },
  mainTitleView: { width: '90%' },
  TimeLineTitleView: { marginHorizontal: DimensionHelper.wp(3), alignItems: 'flex-start', marginVertical: DimensionHelper.wp(1.5) },
  PostTitleViewStyle: { flexDirection: 'row', marginHorizontal: DimensionHelper.wp(1.5), marginTop: DimensionHelper.wp(1) },
  ImageView: { alignItems: 'center', justifyContent: 'center', width: DimensionHelper.wp(35), marginTop: DimensionHelper.wp(2), backgroundColor: "#000000", },
  ...
  postTitleView: { flexDirection: 'row', marginTop: DimensionHelper.wp(1), justifyContent: 'space-between', marginHorizontal: DimensionHelper.wp(1), },
  TitleTextStyle: { fontSize: DimensionHelper.wp(2), color: Constants.Colors.white_color, fontFamily: Constants.Fonts.RobotoMedium },
  eventTextStyle: { fontSize: DimensionHelper.wp(1.6), color: 'black', fontFamily: Constants.Fonts.RobotoMedium },
  DateTextColor: { fontFamily: Constants.Fonts.RobotoRegular },
  planTextStyle: { fontSize: DimensionHelper.wp(1.5), color: 'black', fontFamily: Constants.Fonts.RobotoRegular },
  ...
  fundInput: { color: 'gray', fontFamily: Constants.Fonts.RobotoMedium, height: DimensionHelper.wp(12), width: DimensionHelper.wp(40), alignItems: 'center', justifyContent: 'center', paddingHorizontal: DimensionHelper.wp(2), marginLeft: DimensionHelper.wp(5), borderWidth: 1, borderRadius: DimensionHelper.wp(2), borderColor: 'lightgray', marginTop: DimensionHelper.wp(2), },
  ...
  feesContainer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginHorizontal: DimensionHelper.wp(5.8), marginTop: DimensionHelper.wp(3) },
  checkBox: { marginHorizontal: DimensionHelper.wp(3) },
  feesText: { fontSize: DimensionHelper.wp(4.5), fontFamily: Constants.Fonts.RobotoLight, color: 'gray' },
  ...
  LatestUpdateTextStyle: { color: 'black', fontSize: DimensionHelper.wp(2), fontFamily: Constants.Fonts.RobotoMedium },
  ...
  //Notification screen
  NotificationView: { marginVertical: DimensionHelper.wp(0.5), flexDirection: 'row', width: DimensionHelper.wp(94), borderRadius: DimensionHelper.wp(2), borderColor: 'lightgray', alignSelf: 'center', borderWidth: 1, alignItems: 'center', paddingVertical: DimensionHelper.wp(1), paddingRight: DimensionHelper.wp(1) },
  bellIcon: { width: DimensionHelper.wp(6), height: DimensionHelper.wp(6) },
  NotificationText: { fontSize: DimensionHelper.wp(1.5), color: 'black', fontFamily: Constants.Fonts.RobotoMedium },
  ...
  TableHeaderTitle: { fontSize: DimensionHelper.wp(1.7), color: 'black', fontFamily: Constants.Fonts.RobotoMedium },
  CancelAddbuttonView: { alignItems: 'center', marginVertical: DimensionHelper.wp(2), flexDirection: 'row', alignSelf: 'flex-end', },
  SaveButtonStyle: { marginLeft: DimensionHelper.wp(3), backgroundColor: Constants.Colors.app_color, borderRadius: DimensionHelper.wp(1.5), paddingVertical: DimensionHelper.wp(1), paddingHorizontal: DimensionHelper.wp(2) },
  ...
  planTitleView: { marginLeft: DimensionHelper.wp(2), marginVertical: DimensionHelper.wp(2), flexDirection: 'row', alignItems: 'center', },
  statusView: { marginHorizontal: DimensionHelper.wp(2), flexDirection: 'row', alignItems: 'center', padding: DimensionHelper.wp(1.5) },
