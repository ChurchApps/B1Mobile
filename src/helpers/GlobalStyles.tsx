...
export const globalStyles = StyleSheet.create({
  ...
  BadgeDot:{ position:'absolute', right:25, width:DimensionHelper.wp('2.5%'), height: DimensionHelper.wp('2.5%'),borderRadius: DimensionHelper.wp('1.25%'),backgroundColor: 'red'},
  ...
  //Household
  memberListIcon: { width: DimensionHelper.wp('16%'), height: DimensionHelper.wp('16%'), marginHorizontal: DimensionHelper.wp('2%'), marginVertical: DimensionHelper.wp('2%'), borderRadius: DimensionHelper.wp('1.5%') },
  ...
  groupText: { color: Constants.Colors.app_color, fontSize: DimensionHelper.wp('4.2%'), marginHorizontal: DimensionHelper.wp('2.5%') },
  ...
  methodModalText: { color: 'black', fontSize: DimensionHelper.wp('4%') },
