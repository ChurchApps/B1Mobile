...
const LazyEnhancedDonationForm = lazy(() =>
  import("./EnhancedDonationForm").then(module => ({ default: module.EnhancedDonationForm })));

const LazyEnhancedGivingHistory = lazy(() =>
  import("./EnhancedGivingHistory").then(module => ({ default: module.EnhancedGivingHistory })));

const LazyPaymentMethods = lazy(() =>
  import("./PaymentMethods").then(module => ({ default: module.PaymentMethods })));
