...
export function Donations() {
  ...
  const renderDonationItem = useCallback(
    ({ item: donation }: { item: DonationInterface }) => (
      <List.Item
        title={DateHelper.prettyDate(DateHelper.toDate(donation.donationDate || ""))}
    ...
    <>
      <Portal>
        <Modal
          ...
          <ScrollView>
            <List.Section>
              <List.Item title={t("donations.date")} description={DateHelper.prettyDate(DateHelper.toDate(selectedDonation.donationDate || ""))} />
