...
import { AssignmentInterface, Constants, EnvironmentHelper, PersonInterface, PositionInterface, globalStyles } from "../../helpers";
  ...
  return  (   
    <View key={item.id}>
          <View style={{flexDirection: 'row', alignItems: 'center', padding: 10 }}>
            <Image
              source={{ uri: EnvironmentHelper.ContentRoot + item?.item?.photo }}
